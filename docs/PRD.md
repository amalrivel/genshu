...
It defines product scope, user behavior, requirements, acceptance criteria,
and explicitly excluded functionality.

Technical implementation decisions belong in `ARCHITECTURE.md`.
User-interface and interaction decisions belong in `UI-UX.md`.
Significant decisions and their rationale belong in `DECISIONS.md`.

The September 2026 Next.js rebuild resets the implementation, not the
