...
## Corpus Check
- 146 files · ~102,882 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 376 nodes · 733 edges · 94 communities (18 shown, 75 thin omitted)
...
Cohesion: 0.10
Nodes (19): lucide-react, next-themes, metadata, LanguageToggle(), AppHeader(), managementItems, NavItem, primaryItems (+11 more)
