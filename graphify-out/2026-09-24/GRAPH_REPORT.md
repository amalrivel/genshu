...
## Corpus Check
- 217 files · ~100,378 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 737 nodes · 1278 edges · 140 communities (40 shown, 99 thin omitted)
...
## Communities (140 total, 99 thin omitted)

### Community 0 - "cohorts/[id]/page.tsx"
Cohesion: 0.08
Nodes (73): lucide-react, next-intl, react, AssignmentDetailPage(), AssignmentsPage(), SessionRollCallPage(), STATUS_OPTIONS, AttendancePage() (+65 more)

### Community 1 - "package.json"
Cohesion: 0.09
Nodes (21): ignoreScripts, name, packageManager, private, trustedDependencies, version, babel-plugin-react-compiler, @base-ui/react (+13 more)
...
Cohesion: 0.07
Nodes (50): postgres, signIn(), signOut(), dynamic, LoginPage(), MaterialsPage(), MaterialPage(), dynamic (+42 more)
...
- **Why does `react` connect `cohorts/[id]/page.tsx` to `package.json`, `app-header.tsx`, `dropdown-menu.tsx`, `data-context.tsx`, `content-repository.ts`, `tabs.tsx`?**
...
- **Should `cohorts/[id]/page.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.08193339227821986 - nodes in this community are weakly interconnected._
