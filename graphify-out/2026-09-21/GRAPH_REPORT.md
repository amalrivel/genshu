...
## Corpus Check
- 354 files · ~528,687 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4726 nodes · 7222 edges · 385 communities (277 shown, 108 thin omitted)
...
## Communities (385 total, 108 thin omitted)

### Community 0 - "assignments/[id]/page.tsx"
Cohesion: 0.27
Nodes (17): react, Card(), CardContent(), CardDescription(), CardHeader(), CardTitle(), DestructiveConfirmDialogProps, Dialog() (+9 more)
...
Cohesion: 0.12
Nodes (14): CohortDetailContent(), CohortTab, cohortTabs, DestructiveAction, isCohortTab(), CohortStatusBadge(), CohortStatusBadgeProps, DestructiveConfirmDialog() (+6 more)
...
Cohesion: 0.15
Nodes (19): class-variance-authority, AssignmentDetailPage(), AssignmentsPage(), SessionRollCallPage(), AttendancePage(), CohortsPage(), ExamDetailPage(), ExamsPage() (+11 more)
...
### Community 271 - "Operate mode depth (and Read notes)"
Cohesion: 0.22
...
- **Why does `search()` connect `search` to `validate_data.py`, `generate_design_system`, `design_system.py`, `detect_domain`, `BM25`, `scripts/core.py`, `test_style_taxonomy.py`, `test_text_layout_resilience.py`, `_row_identities`, `DesignSystemGenerator`?**
...
- **Why does `search_stack()` connect `search_stack` to `generate_design_system`, `BM25`, `scripts/core.py`, `search`, `test_text_layout_resilience.py`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `generate_design_system`, `design_system.py`, `test_design_system_mode.py`, `parse_decision_rules`, `BM25`, `_palette_is_dark`, `test_data_contracts.py`, `_select_palette_for_mode`?**
