# Graph Report - genshu  (2026-09-21)

## Corpus Check
- 355 files · ~528,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4732 nodes · 7253 edges · 386 communities (279 shown, 107 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 116 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e26f6276`
...
8. `connectSSE()` - 34 edges
9. `ShadcnInstaller` - 34 edges
10. `setLiveState()` - 33 edges
...
## Communities (386 total, 107 thin omitted)

### Community 0 - "assignments/[id]/page.tsx"
Cohesion: 0.23
Nodes (23): class-variance-authority, next-intl, react, StudentProfileDrawer(), Badge(), BadgeProps, badgeVariants, Card() (+15 more)
...
Cohesion: 0.11
Nodes (16): next-themes, metadata, AppHeader(), managementItems, NavItem, primaryItems, ThemeProvider(), DropdownMenu() (+8 more)
...
Cohesion: 0.03
Nodes (136): addManualContextText(), applyPlaceholderSizingStyles(), averageRgb01(), bufferToBase64(), buildCollapsible(), buildColorModels(), buildListHtml(), buildRadiiModels() (+128 more)
...
### Community 92 - "cohorts/[id]/page.tsx"
Cohesion: 0.18
Nodes (13): CohortDetailContent(), CohortTab, cohortTabs, DestructiveAction, isCohortTab(), CohortStatusBadge(), CohortStatusBadgeProps, DestructiveConfirmDialog() (+5 more)
...
Cohesion: 0.19
Nodes (11): lucide-react, LanguageToggle(), PageHeader(), PageHeaderProps, PageShell(), PageShellProps, SectionHeader(), SectionHeaderProps (+3 more)

### Community 95 - "resumeSession"
Cohesion: 0.06
Nodes (77): applyParamDefaults(), applyParamValue(), applySavedSessionMeta(), buildCyclingRow(), buildParamsPanel(), clampVariantIndex(), clearHandled(), closedClipPath() (+69 more)

### Community 96 - "setLiveState"
Cohesion: 0.10
Nodes (58): applyEditing(), beginNewLiveConfiguration(), buildInsertPlaceholderSnapshotFromDom(), buildLocatorForLeaf(), buildPickedAnchorSnapshot(), cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure() (+50 more)

### Community 97 - "validate_data.py"
Cohesion: 0.12
Nodes (34): _catalog_date(), _check_app_interface_contract(), _check_catalog_contract(), _check_catalog_summary(), _check_color_contract(), _check_core_data_contract(), _check_file(), _check_font_catalog() (+26 more)

### Community 98 - "initPageChat"
Cohesion: 0.08
...
Cohesion: 0.04
Nodes (45): 10. Data Platform, 11. Authentication, 12. File Storage, 13. Deployment Direction, 14. Architecture Principle, 15. Anti-Overengineering Rules, 16. UX Principles, 17. Mobile and Desktop (+37 more)

### Community 104 - "brandkit/SKILL.md"
Cohesion: 0.05
Nodes (43): 1. Logo Cover, 1. Monogram + Meaning, 2 × 3 REFERENCE-STYLE LAYOUT, 2. Logo Construction, 2. Product Action, 3. Digital Application, 3. Metaphor Fusion, 4. Brand Essence (+35 more)

### Community 105 - "slide_search_core.py"
Cohesion: 0.08
...
Cohesion: 0.10
Nodes (32): agentHasWorkInFlight(), agentStatusText(), applyGlobalBarLabelState(), applyLiveBarPreference(), barPaletteForTheme(), brandMarkSvg(), buildDesignHeader(), designPanelCss() (+24 more)

### Community 108 - "Brand Guidelines v1.0"
Cohesion: 0.05
Nodes (37): 1. Color Palette, 2. Typography, 3. Logo Usage, 4. Voice & Tone, 5. Imagery Guidelines, 6. Design Components, Accessibility, AI Image Generation (+29 more)

### Community 109 - "scripts/core.py"
Cohesion: 0.10
...
### Community 110 - "Genshu AI Development Playbook"
Cohesion: 0.05
Nodes (37): 10. Verification Principle, 11. Completion Reporting, 12. Permanent Knowledge vs Temporary Output, 13. Dependency Discipline, 14. Architectural Changes, 15. Documentation Maintenance, 16. External Agent Skills, 17. Playbook Maintenance (+29 more)

### Community 111 - "Design"
Cohesion: 0.06
...
### Community 112 - "Canvas Design System"
Cohesion: 0.06
Nodes (35): 1. Visual Communication First, 2. Minimal Text Integration, 3. Expert Craftsmanship, 4. Systematic Patterns, Analog Meditation, Approach, Canvas Boundaries, Canvas Design System (+27 more)

### Community 113 - "Expo Animation Recipes"
Cohesion: 0.06
...
### Community 114 - "CORE DIRECTIVE: IMAGE-FIRST WEBSITE DESIGN TO CODE"
Cohesion: 0.06
...
### Community 115 - "CORE DIRECTIVE: PREMIUM MOBILE APP IMAGE DIRECTION"
Cohesion: 0.06
...
### Community 117 - "Animation Recipes"
Cohesion: 0.06
...
### Community 118 - "Form & Input Components"
Cohesion: 0.06
Nodes (32): Accordion, Alert, Alert Dialog, Avatar, Badge, Button, Card, Checkbox (+24 more)

### Community 119 - "Tailwind CSS Responsive Design"
Cohesion: 0.06
Nodes (32): 1. Mobile-First Design, 2. Consistent Breakpoint Usage, 3. Test at Breakpoint Boundaries, 4. Use Container for Content Width, 5. Progressive Enhancement, 6. Avoid Too Many Breakpoints, Best Practices, Breakpoint System (+24 more)

### Community 120 - "test_core_data_quality.py"
Cohesion: 0.14
...
### Community 122 - "Typography Specifications"
Cohesion: 0.06
Nodes (30): Accessibility, Base System, Best Practices, Clean & Modern, Common Font Pairings, Contrast Requirements, CSS Implementation, Editorial (+22 more)

### Community 123 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 124 - "connectSSE"
Cohesion: 0.07
Nodes (59): abandonForeignSession(), abandonSupersededGo(), abortSvelteComponentInjection(), applyOriginalAttrsToSvelteAnchor(), cleanup(), clearMountErrorCard(), clearScrollY(), clearSession() (+51 more)

### Community 125 - "Logo Usage Rules"
Cohesion: 0.07
...
### Community 126 - "Component Specifications"
Cohesion: 0.07
Nodes (28): Alert, Anatomy, Anatomy, Anatomy, Anatomy, Anatomy, Badge, Button (+20 more)

### Community 127 - "html-token-validator.py"
Cohesion: 0.12
...
### Community 129 - "shadcn/ui Accessibility Patterns"
Cohesion: 0.07
...
### Community 130 - "TestTailwindConfigGenerator"
Cohesion: 0.07
...
### Community 131 - "impeccable/SKILL.md"
Cohesion: 0.09
Nodes (21): Assess Adaptation Challenge, Implement & Verify, Recommended Actions, Recommended Actions, Craft (deprecated alias), Apply, Live-mode signature params, Set the spatial thesis (+13 more)

### Community 132 - "Animation Standards Reference"
Cohesion: 0.07
...
### Community 134 - "design_system.py"
Cohesion: 0.10
...
### Community 137 - "Responsive Design"
Cohesion: 0.08
...
### Community 139 - "Color Palette Management"
Cohesion: 0.08
...
### Community 140 - "CIP Deliverable Guide"
Cohesion: 0.08
...
### Community 142 - "Animation Audit Playbook"
Cohesion: 0.08
...
### Community 143 - "UI Styling Skill"
Cohesion: 0.08
...
### Community 146 - "handleManualEditActivity"
Cohesion: 0.15
Nodes (28): clearStoredManualApplyState(), fetchPendingCount(), handleManualEditActivity(), hasTextRows(), hidePendingApplyDock(), manualApplyLoadingText(), manualApplyStateKey(), manualEditEventForCurrentPage() (+20 more)

### Community 147 - "Design System"
Cohesion: 0.09
...
### Community 148 - "onboard.md"
Cohesion: 0.09
Nodes (22): Assess Onboarding Needs, Context Over Ceremony, Contextual Help, Design Onboarding Experiences, Documentation & Help, Empty State Design, Feature Discovery & Adoption, Guided Tours & Walkthroughs (+14 more)

### Community 149 - "onAnnotDown"
Cohesion: 0.15
Nodes (21): applyPlaceholderDimensions(), beginEditPin(), buildAnnotationsForCapture(), buildPinElement(), cancelEditingPin(), clampPlaceholderSize(), finalizeEditingPin(), initAnnotOverlay() (+13 more)

### Community 150 - "Tailwind CSS Customization"
Cohesion: 0.09
Nodes (22): @apply Directive, Best Practices, Color Customization, Complete Tailwind Config, Configuration Examples, Content Configuration, Custom Color Palette, Custom Font Sizes (+14 more)

### Community 151 - "Write Swift"
Cohesion: 0.09
...
### Community 152 - "useData"
Cohesion: 0.12
Nodes (18): cn, AssignmentDetailPage(), AssignmentsPage(), SessionRollCallPage(), AttendancePage(), CohortsPage(), ExamDetailPage(), ExamsPage() (+10 more)

### Community 153 - "Apple Design"
Cohesion: 0.09
...
### Community 156 - "TailwindConfigGenerator"
Cohesion: 0.09
...
### Community 157 - "DesignSystemGenerator"
Cohesion: 0.08
Nodes (13): DesignSystemGenerator, Generates design system recommendations from aggregated searches., Load reasoning rules from CSV., TestReasoningMatch, Cross-file semantic contracts for curated design data., read_rows(), split_values(), style_identities() (+5 more)

### Community 158 - "generate-slide.py"
Cohesion: 0.14
...
### Community 159 - "Operate mode depth (and Read notes)"
Cohesion: 0.10
...
### Community 164 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
...
### Community 165 - "test_design_system_mode.py"
Cohesion: 0.14
...
### Community 167 - "Asset Organization Guide"
Cohesion: 0.11
...
### Community 168 - "Primary Color Meanings"
Cohesion: 0.11
...
### Community 177 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 178 - "createLiveBrowserSessionState"
Cohesion: 0.21
...
### Community 179 - "TestThresholdGate"
Cohesion: 0.12
...
### Community 182 - "CORE DIRECTIVE: AWWWARDS-LEVEL IMAGE ART DIRECTION"
Cohesion: 0.12
Nodes (16): 10. SECTION RHYTHM RULE, 12. DENSITY & SPACING DISCIPLINE, 14. IMAGE / MEDIA DIRECTION, 16. MULTI-IMAGE CONSISTENCY RULE, 17. CLARITY CHECK, 19. RESPONSE BEHAVIOR, 1. ACTIVE BASELINE CONFIGURATION, 21. FINAL GOAL (+8 more)

### Community 183 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 196 - "Appendix B - Canonical Sources (read these before reinventing)"
Cohesion: 0.13
Nodes (15): Appendix B - Canonical Sources (read these before reinventing), Apple Liquid Glass (Apple platforms only), Atlassian, Bootstrap, Carbon, Fluent UI, GOV.UK, Material Web (+7 more)

### Community 197 - "Generate Report"
Cohesion: 0.29
...
### Community 198 - "Copywriting Formulas"
Cohesion: 0.13
Nodes (14): AIDA (Attention-Interest-Desire-Action), Before-After-Bridge, Contrast Patterns, Copywriting Formulas, Core Formulas, Cost of Inaction, FAB (Features-Advantages-Benefits), Formula-to-Slide Mapping (+6 more)

### Community 199 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 200 - "detect_domain"
Cohesion: 0.23
Nodes (3): detect_domain(), Auto-detect the most relevant domain from query. Matches are weighted by…, TestDomainDetection

### Community 202 - "_select_palette_for_mode"
Cohesion: 0.11
...
### Community 203 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
...
### Community 204 - "Messaging Framework"
Cohesion: 0.14
...
### Community 205 - "Brand Voice Framework"
Cohesion: 0.14
...
### Community 206 - "extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 207 - "validate-asset.cjs"
Cohesion: 0.25
Nodes (13): checkManifest(), formatBytes(), formatOutput(), fs, main(), parseFilename(), path, RULES (+5 more)

### Community 208 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 209 - "Tailwind Integration"
Cohesion: 0.14
...
### Community 210 - "radius"
Cohesion: 0.19
Nodes (14): $type, $value, $type, $value, $type, $value, primitive, radius (+6 more)

### Community 211 - "2. THE COMBINATORIAL VARIATION ENGINE"
Cohesion: 0.14
...
### Community 214 - "actOnAgentTarget"
Cohesion: 0.26
...
### Community 216 - "test_tailwind_config_gen.py"
Cohesion: 0.16
...
### Community 217 - "Working With Sonner"
Cohesion: 0.15
...
### Community 221 - "design-tokens-starter.json"
Cohesion: 0.15
Nodes (12): component, $type, $value, dark, semantic, $schema, $type, $value (+4 more)

### Community 222 - "document.md"
Cohesion: 0.08
...
### Community 224 - "Primitive Tokens"
Cohesion: 0.17
...
### Community 225 - "validate-tokens.cjs"
Cohesion: 0.24
...
### Community 227 - "4. DESIGN ENGINEERING DIRECTIVES (Bias Correction)"
Cohesion: 0.17
Nodes (12): 4.10 Quotes & Testimonials, 4.11 Page Theme Lock (Light / Dark Mode Consistency), 4.1 Typography, 4.2 Color Calibration, 4.3 Layout Diversification, 4.4 Materiality, Shadows, Cards, 4.5 Interactive UI States, 4.6 Data & Form Patterns (+4 more)

### Community 228 - "critique.md"
Cohesion: 0.17
...
### Community 229 - "Simplify the Design"
Cohesion: 0.17
...
### Community 237 - "embed-tokens.cjs"
Cohesion: 0.18
...
### Community 239 - "Nielsen's 10 Heuristics"
Cohesion: 0.18
...
### Community 241 - "cohort-roster-panels.tsx"
Cohesion: 0.14
Nodes (9): CohortMembers, CohortRosterPanels(), CohortRosterPanelsProps, Translation, StudentProfileDrawerProps, EmptyState(), EmptyStateProps, Table() (+1 more)

### Community 242 - "polish.md"
Cohesion: 0.18
...
### Community 243 - "quieter.md"
Cohesion: 0.18
Nodes (10): Assess Current State, Color Refinement, Composition Refinement, Motion Reduction, Plan Refinement, Refine the Design, Simplification, Verify Quality (+2 more)

### Community 244 - "The list"
Cohesion: 0.18
...
### Community 247 - "test_text_layout_resilience.py"
Cohesion: 0.20
...
### Community 249 - "Slide Strategies"
Cohesion: 0.20
...
### Community 250 - "Component Tokens"
Cohesion: 0.20
...
### Community 251 - "generate-tokens.cjs"
Cohesion: 0.36
Nodes (9): flattenTokens(), fs, generateCSS(), generateTailwind(), main(), parseArgs(), path, resolveReference() (+1 more)

### Community 252 - "button"
Cohesion: 0.20
Nodes (10): fg, font-size, hover-bg, button, $type, $value, $type, $value (+2 more)

### Community 253 - "duration"
Cohesion: 0.20
Nodes (10): fast, normal, slow, $type, $value, $type, $value, duration (+2 more)

### Community 254 - "10. REFERENCE VOCABULARY (Pattern Names the Agent Should Know)"
Cohesion: 0.20
Nodes (10): 10. REFERENCE VOCABULARY (Pattern Names the Agent Should Know), Animation Library Choice, Cards & Containers, Galleries & Media, Hero Paradigms, Layout & Grids, Micro-Interactions & Effects, Navigation & Menus (+2 more)

### Community 255 - "CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING"
Cohesion: 0.20
...
### Community 256 - "22. STYLE VARIATION ENGINE"
Cohesion: 0.20
...
### Community 257 - "Init flow"
Cohesion: 0.20
Nodes (10): Completion gate, Init flow, Step 1: Load current state, Step 2: Explore the project, Step 3: Interview for product truth, Step 4: Write PRODUCT.md, Step 5: Record workflow defaults, Step 6: Wrap up or resume (+2 more)

### Community 258 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 259 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)

### Community 260 - "._base_config"
Cohesion: 0.22
...
### Community 261 - "generate_design_system"
Cohesion: 0.22
...
### Community 263 - "parse_decision_rules"
Cohesion: 0.10
...
### Community 264 - "sync-brand-to-tokens.cjs"
Cohesion: 0.33
...
### Community 266 - "Design Engineering"
Cohesion: 0.22
Nodes (8): Accessibility, Design Engineering, Initial Response, prefers-reduced-motion, Review Checklist, Review Format (Required), Stagger Animations, Touch device hover states

### Community 267 - "11. COMPONENT EXECUTION GUIDELINES"
Cohesion: 0.22
...
### Community 268 - "18. EXTRA CREATIVITY & IMPLEMENTATION EDGE"
Cohesion: 0.22
...
### Community 269 - "Common Cognitive Load Violations"
Cohesion: 0.22
Nodes (9): 1. The Wall of Options, 2. The Memory Bridge, 3. The Hidden Navigation, 4. The Jargon Barrier, 5. The Visual Noise Floor, 6. The Inconsistent Pattern, 7. The Multi-Task Demand, 8. The Context Switch (+1 more)

### Community 270 - "iOS platform"
Cohesion: 0.22
...
### Community 274 - "9. AI TELLS (Forbidden Patterns)"
Cohesion: 0.25
Nodes (8): 9.A Visual & CSS, 9. AI TELLS (Forbidden Patterns), 9.B Typography, 9.C Layout & Spacing, 9.D Content & Data ("Jane Doe" Effect), 9.E External Resources & Components, 9.F Production-Test Tells (banned outright), 9.G EM-DASH BAN (the single most-violated Tell)

### Community 275 - "Component Building Principles"
Cohesion: 0.25
Nodes (8): Animate enter states with @starting-style, Buttons must feel responsive, Component Building Principles, Make popovers origin-aware, Never animate from scale(0), Tooltips: skip delay on subsequent hovers, Use blur to mask imperfect transitions, Use CSS transitions over keyframes for interruptible UI

### Community 276 - "12. THE COMBINATORIAL VARIATION ENGINE"
Cohesion: 0.25
...
### Community 277 - "8. ANTI-AI-SLOP RULES"
Cohesion: 0.25
Nodes (8): 8. ANTI-AI-SLOP RULES, Carousel / marquee slop (layout), Content slop, Data / KPI slop, Density slop, Layout slop, Typography slop, Visual slop

### Community 278 - "Adaptation Strategies"
Cohesion: 0.40
...
### Community 279 - "Android platform"
Cohesion: 0.25
...
### Community 280 - "scheduleAcceptCleanup"
Cohesion: 0.31
...
### Community 281 - "Persona-Based Design Testing"
Cohesion: 0.25
Nodes (8): 1. Impatient Power User: "Alex", 2. Confused First-Timer: "Jordan", 3. Accessibility-Dependent User: "Sam", 4. Deliberate Stress Tester: "Riley", 5. Distracted Mobile User: "Casey", Persona-Based Design Testing, Project-Specific Personas, Selecting Personas

### Community 282 - "doctor.md"
Cohesion: 0.25
...
### Community 283 - "Extract Flow"
Cohesion: 0.25
Nodes (7): Extract Flow, Step 1: Discover the Design System, Step 2: Identify Patterns, Step 3: Plan Extraction, Step 4: Extract & Enrich, Step 5: Migrate, Step 6: Document

### Community 284 - "_row_identities"
Cohesion: 0.25
...
### Community 287 - "APPENDICES - Real Source-Backed Reference Material"
Cohesion: 0.29
...
### Community 294 - "4. HERO MINIMALISM RULES"
Cohesion: 0.29
...
### Community 303 - "The Animation Decision Framework"
Cohesion: 0.33
Nodes (6): 1. Should this animate at all?, 2. What is the purpose?, 3. What easing should it use?, 4. How fast should it be?, Perceived performance, The Animation Decision Framework

### Community 304 - "clip-path for Animation"
Cohesion: 0.33
Nodes (6): clip-path for Animation, Comparison sliders, Hold-to-delete pattern, Image reveals on scroll, Tabs with perfect color transitions, The inset shape

### Community 305 - "Performance Rules"
Cohesion: 0.33
Nodes (6): CSS animations beat JS under load, CSS variables are inheritable, Framer Motion hardware acceleration caveat, Only animate transform and opacity, Performance Rules, Use WAAPI for programmatic CSS animations

### Community 306 - "Gesture and Drag Interactions"
Cohesion: 0.33
Nodes (6): Damping at boundaries, Friction instead of hard stops, Gesture and Drag Interactions, Momentum-based dismissal, Multi-touch protection, Pointer capture for drag

### Community 307 - "29. ANTI-AI-SLOP RULES"
Cohesion: 0.33
Nodes (6): 29. ANTI-AI-SLOP RULES, Content slop, Density slop, Layout slop, Typography slop, Visual slop

### Community 308 - "5. IMAGE COUNT & PAGE SLICING"
Cohesion: 0.33
...
### Community 309 - "bolder.md"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat

### Community 310 - "Visualize: Direction Comps & Asset Production"
Cohesion: 0.33
...
### Community 319 - "12. THE BLOCK LIBRARY (Contract - Implementations Land Here Iteratively)"
Cohesion: 0.40
Nodes (5): 12.A File Location, 12.B Required Frontmatter, 12.C Required Body Sections, 12.D Block-Library Discipline, 12. THE BLOCK LIBRARY (Contract - Implementations Land Here Iteratively)

### Community 320 - "5. CONTEXT-AWARE PROACTIVITY"
Cohesion: 0.40
Nodes (5): 5.A Sticky-Stack - Canonical Skeleton, 5.B Horizontal-Pan - Canonical Skeleton, 5.C Scroll-Reveal Stagger - Canonical Skeleton (lighter alternative), 5. CONTEXT-AWARE PROACTIVITY, 5.D Forbidden Animation Patterns

### Community 321 - "8. DARK MODE PROTOCOL"
Cohesion: 0.40
Nodes (5): 8.A Token Strategy (pick one, stick to it), 8.B Do Not Prescribe Specific Colors Here, 8.C Default Mode, 8.D Test in Both Modes Before Finishing, 8. DARK MODE PROTOCOL

### Community 322 - "CSS Transform Mastery"
Cohesion: 0.40
Nodes (5): 3D transforms for depth, CSS Transform Mastery, scale() scales children too, transform-origin, translateY with percentages

### Community 323 - "The Sonner Principles (Building Loved Components)"
Cohesion: 0.40
Nodes (5): Asymmetric enter/exit timing, Cohesion matters, Review your work the next day, The opacity + height combination, The Sonner Principles (Building Loved Components)

### Community 324 - "Spring Animations"
Cohesion: 0.40
Nodes (5): Interruptibility advantage, Spring Animations, Spring-based mouse interactions, Spring configuration, When to use springs

### Community 325 - "21. MOBILE ANTI-AI-TELLS RULE"
Cohesion: 0.40
Nodes (5): 21. MOBILE ANTI-AI-TELLS RULE, Copy AI tells, Layout AI tells, UI clutter tells, Visual AI tells

### Community 326 - "Impeccable Documenter"
Cohesion: 0.40
Nodes (4): Impeccable Documenter, Input Contract, Output Contract, Workflow

### Community 327 - "slide-token-validator.py"
Cohesion: 0.50
...
### Community 349 - "destructive"
Cohesion: 0.67
Nodes (3): destructive, $type, $value

### Community 350 - "destructive-foreground"
Cohesion: 0.67
...
### Community 352 - "primary-foreground"
Cohesion: 0.67
...
### Community 354 - "secondary-foreground"
Cohesion: 0.67
Nodes (3): secondary-foreground, $type, $value

### Community 385 - "syncEditBadgeHitProxies"
Cohesion: 0.27
Nodes (10): bindEditBadgeProxy(), editBadgeProxyTargets(), initEditBadge(), initEditBadgeHitProxies(), positionEditBadge(), proxyMouseEvent(), setImportantStyle(), styleEditBadgeProxy() (+2 more)

### Community 387 - "Diagnostic Scan"
Cohesion: 0.33
...
- **Why does `search()` connect `search` to `generate_design_system`, `design_system.py`, `parse_decision_rules`, `detect_domain`, `BM25`, `scripts/core.py`, `test_text_layout_resilience.py`, `test_core_data_quality.py`, `search_stack`, `_row_identities`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `search_stack()` connect `search_stack` to `generate_design_system`, `BM25`, `scripts/core.py`, `search`, `test_text_layout_resilience.py`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `test_design_system_mode.py`, `generate_design_system`, `design_system.py`, `parse_decision_rules`, `BM25`, `_select_palette_for_mode`?**
